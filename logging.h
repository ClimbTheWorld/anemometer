 ...
 * [0] : FileContLog:    "YYYYcont.txt" (16+1 chars)  ->> "YYYY" (to save space -> just the year will be saved)
 * [1] : FileDayLog:     "YYYYday.txt" (15+1 chars)   ->> "YYYY" (to save space -> just the year will be saved)
 * [2] : FileMonthLog:   "YYYYmont.txt" (17+1 chars) ->> "YYYY-MM" (to save space -> just the year and month will be saved) ->> (8)
