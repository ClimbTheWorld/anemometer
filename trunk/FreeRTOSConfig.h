...
#define configTICK_RATE_HZ                  ((portTickType) 1000) //LUK 3.6.2011: was originally 100
#define configMAX_PRIORITIES                ((unsigned portBASE_TYPE) 5) //LUK 2011-05-31 was 5
#define configMINIMAL_STACK_SIZE            ((unsigned portSHORT) 128) // was 128
...
/* Timer1 is needed to give the ability for run-time-stats. As we use Timer0 for counting the flowrate we have to abandon the option for run-time-stats.
 diese Zeile: '#define configGENERATE_RUN_TIME_STATS       0' bedarf noch zusätzlich einer Auskommentierung der Zeile 'portCONFIGURE_TIMER_FOR_RUN_TIME_STATS();' im File tasks.c, Funktion 'void vTaskStartScheduler( void )' 
 */
...
#define configUSE_ALTERNATIVE_API           1 //LUK 2011-01-31
#define configCHECK_FOR_STACK_OVERFLOW      2 //LUK 2011-05-31: original it was =2. should be faster afterwards; less head for task-switch
