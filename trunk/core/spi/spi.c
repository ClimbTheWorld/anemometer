...
void spiInit (void)
{
  ...
  //    LSB out first
  //    No interrupts
  //SPI_SPCR = SPI_SPCR_MSTR | SPI_SPCR_CPHA1ST | SPI_SPCR_CPOLACTHIGH | SPI_SPCR_LSBF;
  //SPI_SPCR = SPI_SPCR_MSTR | SPI_SPCR_CPHA2ND | SPI_SPCR_CPOLACTLOW | SPI_SPCR_LSBF;
  SPI_SPCR = SPI_SPCR_MSTR | SPI_SPCR_CPHA2ND | SPI_SPCR_CPOLACTHIGH | SPI_SPCR_LSBF;

  //  Reading the status register clears it
  spsr = SPI_SPSR;

  //  SCK0 = (PCLK = (CCLK/APB)) / 250 will be 192khz (putt putt putt...)
  SPI_SPCCR = 8;
}
