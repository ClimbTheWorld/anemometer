/*-------------------------------------------------------------------------
   Register Declarations for the Atmel AT89C51RD2/ED2 Processor

   Written By -  Jesus Calvino-Fraga / jesusc at ece.ubc.ca (July 2005)
...
#include "8052.h"     // Load definitions for the 8052 aus Projektverzeichnis
